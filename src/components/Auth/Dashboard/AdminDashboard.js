...
const DashboardContent = () => {
    ...
    const fetchData = async () => {
      ...
      const handleDelete = (coffee) => {
        ...
        axios.delete(`https://coffee-bean-backend-production.up.railway.app/api/delete/${coffee._id}`)
        setDeleted(true)
        setTimeout(() => {
            setDeleted(false)
        }, 3000);
      ...
      const handleUpdate = (e) => {
            e.preventDefault()
            axios.put(`https://coffee-bean-backend-production.up.railway.app/api/edit/${editCoffee._id}`, {

...
const Cart = () => {
    ...
    const handleDeleteFromCart = (id) => {
        ...
        axios.delete(`https://coffee-bean-backend-production.up.railway.app/api/cart/${id._id}`, {
            data: {
    ...
    const makePayment = token => {
        ...
        .then(res => {
            axios.delete(`https://coffee-bean-backend-production.up.railway.app/api/cartDelete/${currentUser.email}`)
            setPaid(true)
        })
